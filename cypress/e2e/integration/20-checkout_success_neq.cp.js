it("tests ordercheckout", () => {
  ...
  it("tests checkoutsuccess", () => {
    ...
    cy.get("form > div:nth-of-type(4) > div:nth-of-type(1) select").select("Brazil");
    cy.get("form > div:nth-of-type(4) > div:nth-of-type(2) input").type("500 Main St");
    cy.get("div:nth-of-type(4) > div:nth-of-type(3) input").type("Philadelphia");
    cy.get("div:nth-of-type(4) > div:nth-of-type(4) select").type("Acre");
    cy.get("div:nth-of-type(4) > div:nth-of-type(5) input").type("19102");
    //Credit Card
